...
def inverse(matrix):
    ...
    # Inverse of the matrix by dividing the adjugate by the determinant
    inverse_matrix = [[adjugate_matrix[i][j] / det for j in range(
        len(adjugate_matrix[i]))]
...
def adjugate(matrix):
    ...
    Argument:
        - matrix: list of lists whose adjugate should be calculated
    ...
    adjugate_matrix = []
    # Calculate the cofactor matrix of the input matrix
    ...
    for i in range(len(cofactors)):
        ...
        for j in range(len(cofactors[i])):
            # Transpose the cofactor matrix to get the adjugate matrix
            adjugate_matrix[i].append(cofactors[j][i])
...
def cofactor(matrix):
    ...
    Argument:
        - matrix: list of lists whose cofactor should be calculated
