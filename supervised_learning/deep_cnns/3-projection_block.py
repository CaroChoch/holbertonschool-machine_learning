...
def projection_block(A_prev, filters, s=2):
    ...
    Arguments:
    A_prev -- input tensor of shape
        (m, n_H_prev, n_W_prev, n_C_prev)
    filters -- tuple of ints defining filters:
        F11 -- filters for the first 1x1 conv
        F3  -- filters for the 3x3 conv
        F12 -- filters for the second 1x1 conv
               and the shortcut projection
    s -- stride for the first conv in the main path
         and the shortcut projection
    ...
    # Add main path and shortcut, then apply ReLU
