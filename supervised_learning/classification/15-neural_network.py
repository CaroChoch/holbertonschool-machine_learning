    ...
    def train(self, X, Y, iterations=5000, alpha=0.05,
        ...
        Arguments:
            ...
            verbose (boolean): defines whether or not to print information
                               about the training
            graph (boolean): defines whether or not to graph information
                             about the training once the training has
                             completed
            step (int): number of iterations to graph information about
        Return:
        ...
        # Plot the training data every step iterations if graph is True
        if graph is True:
        ...
        # Return evaluation of the training data after iterations of training
